  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden opacity-30 mix-blend-screen">
      <motion.div
        ...
        className="absolute -top-1/4 -left-1/4 h-[80vh] w-[80vw] rounded-full bg-[var(--color-accent)]/20 blur-[120px]"
      />
      <motion.div
        animate={{
          x: ["20%", "-20%", "10%", "20%"],
        ...
        className="absolute -bottom-1/4 -right-1/4 h-[80vh] w-[80vw] rounded-full bg-emerald-500/10 blur-[120px]"
      />
    </div>
  );
});
